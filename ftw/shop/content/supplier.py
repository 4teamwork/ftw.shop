"""Definition of the Supplier content type
"""
...
SupplierSchema['title'].widget.description = _(u"help_name", default="The supplier's name")

SupplierSchema['description'].widget.visible = {'edit': 'invisible', 'view': 'invisible'}
